...
class ApplicationListViewTests(TestCase):
    ...
    def test_application_list_view_for_authenticated_user(self):
        ...
        self.assertNotIn("Currently, there are no applications recorded.",
...
class CreateApplicationViewTests(TestCase):
    ...
    def test_create_application_post(self):
        """Test that a valid application can be
           created through a POST request."""
        data = {
        ...
        self.assertEqual(application.date_applied.strftime('%Y-%m-%d'),
                         '2024-01-01')
        ...
        self.assertEqual(application.recruiter_contact,
                         'recruiter@example.com')
        self.assertEqual(application.follow_up_date.strftime('%Y-%m-%d'),
                         '2024-02-01')
