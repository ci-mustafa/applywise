...
class Contact(models.Model):
    ...
    Attributes:
        name (CharField): The name of the person submitting the contact message. 
        ...
        message (TextField): The message content that the user wants to send. This is a free 
                             text field that can store long messages.
    """
